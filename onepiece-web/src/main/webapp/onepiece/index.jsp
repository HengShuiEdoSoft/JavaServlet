		...
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-side layui-side-menu">
				<div class="layui-side-scroll">
					<div class="layui-logo" lay-href="/edocms/Home/Welcome">
						<span>一多软件</span>
					</div>
					<ul class="layui-nav layui-nav-tree" lay-shrink="all"
						...
						<dl class="layui-nav-child">
								<dd class="layui-this">
									<a lay-href="/edocms/Home/Welcome">控制台</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/News/List">文章列表</a>
								</dd>
								<dd>
									<a lay-href="/edocms/News/TypeList">分类管理</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/Adverts/AdvertTypeList">广告类型</a>
								</dd>
								<dd>
									<a lay-href="/edocms/Adverts/AdvertList">广告管理</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/Labels/List">标签管理</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/SinglePage/List">单页管理</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/Links/TypeList">链接类型</a>
								</dd>
								<dd>
									<a lay-href="/edocms/Links/List">链接管理</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd>
									<a lay-href="/edocms/Admin/List">后台管理员</a>
								</dd>
								<dd>
									<a lay-href="/edocms/Branch/List">部门管理</a>
								</dd>
								<dd>
									<a lay-href="/edocms/Admin/RoleList">角色管理</a>
								</dd>
								<dd>
									<a lay-href="/edocms/Admin/LogsAllList">操作记录</a>
								</dd>
							</dl></li>
						...
						<dl class="layui-nav-child">
								<dd class="layui-nav-itemed">
									...
									<dl class="layui-nav-child">
										<dd>
											<a lay-href="/edocms/System/WebSite">网站设置</a>
										</dd>
										<dd>
											<a lay-href="/edocms/System/Email">邮件服务</a>
										</dd>
										<dd>
											<a lay-href="/edocms/System/RoleActionList">权限管理</a>
										</dd>
									</dl>
								</dd>
								<dd class="layui-nav-itemed">
									...
									<dl class="layui-nav-child">
										<dd>
											<a lay-href="/edocms/Admin/EditUserInfo">基本资料</a>
										</dd>
										<dd>
											<a lay-href="/edocms/Admin/EditPwd">修改密码</a>
										</dd>
										<dd>
											<a lay-href="/edocms/Admin/LogsList">操作记录</a>
										</dd>
									</dl>
								</dd>
							</dl>
